...
//   return (
//     <div className="min-h-screen bg-[#0B1220] px-10 py-8 text-[#E5E7EB]">
...
//           <button
//             onClick={() => navigate("/progress")}
//             className="text-[#9CA3AF] hover:text-[#A855F7] transition"
//           >
//             Progress
//           </button>
...
//           <h2 className="text-lg font-semibold mb-4 text-[#E5E7EB]">
//             Camera
//           </h2>

//           <div className="h-[260px] bg-black rounded-xl flex items-center justify-center text-[#9CA3AF]">
//             {isMonitoring ? (
//               <WebcamFeed
//                 setBlinkRate={setBlinkRate}
//                 setDistance={setDistance}
...
//           <button
//             onClick={handleToggleMonitoring}
//             className={`mt-5 w-full py-3 rounded-xl font-medium transition transform ${
//               isMonitoring
//                 ? "bg-red-500 hover:bg-red-600"
//                 : "bg-gradient-to-r from-[#A855F7] to-[#EC4899] hover:scale-[1.03]"
//             }`}
//           >
//             {isMonitoring ? "Stop Monitoring" : "Start Monitoring"}
//           </button>
...
//           <button onClick={() => navigate("/monitor")} className="hover:text-white transition">
//             Dashboard
//           </button>
//         </div>
...
//         <p className="text-center text-[#9CA3AF] mb-14">
//           Simple setup, powerful protection for your eyes.
//         </p>
